...
int main(int argc,char **argv)
{
	...
	const char *strPattern = "a=.*packetization-mode=([0-9]+);profile-level-id=([0-9]+);sprop-parameter-sets=([A-Za-z0-9+/=]+),([A-Za-z0-9]+)";//定义模式串
	//const char *strPattern = "a=.*packetization-mode=([0-9]+);profile-level-id=([0-9]+);sprop-parameter-sets=([A-Za-z0-9]+)";//定义模式串
	char *pStrBuf = "a=fmtp:96 packetization-mode=1;profile-level-id=640020;sprop-parameter-sets=Z2QAIKzZQEgG2wEQAAADABAAAAMB6PGDGWA=,aOvjyyLA;";   //定义待匹配串
